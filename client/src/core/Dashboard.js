...
//           </Typography>
//           <Grid container spacing={3} justifyContent="center">
//             {["Aadhar Card", "PAN", "Bank Passbook", "Passport Size Photo"].map(
//               (label) => (
//                 <Grid item xs={12} sm={6} md={3} key={label}>
//                   <Paper elevation={3} sx={{ padding: 3, borderRadius: 2 }}>
//                     <Typography
...
//                     {label}
//                   </Typography>
//                   <InputFileUpload onChange={handleFileChange} label={label} />
//                 </Paper>
//               </Grid>
//             ))}
//           </Grid>
...
//                   Resume
//                 </Typography>
//                 <InputFileUpload onChange={handleFileChange} label="Resume" />
//               </Paper>
//             </Grid>
//           </Grid>
//         </Box>
